...
#define TOKEN "BBFF-qvYEvRiXRh6gdX0CmbpwGkGYFSXYWf" // Your Ubidots TOKEN
...
{
  //modelo
  //1011.93@28.80@1@0@30.34@-2.22367@-79.92608@0@
  if (Serial.available() > 2) 
  {
    ...
    if((incomingString1!=0)||(incomingString2!=0)||(incomingString3!=0))
    {
      ...
      client.add("latitud",  valor6);
      client.add("longitud", valor7);
      client.add("x", valor8);
