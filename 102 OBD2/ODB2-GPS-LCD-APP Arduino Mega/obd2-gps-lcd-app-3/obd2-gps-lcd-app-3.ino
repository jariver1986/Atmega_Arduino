...
//gsm
int conteo=0;
float latitude=-2.22373;
float longitude=-79.92608; //variables de lon y lat
char c='_';
int turno1=0;
int turno2=0;
void setup()
...
void MensajeAlerta(){ 
  ...
  SIM900.print("https://www.google.com/maps/@-2.2217145,-79.9272094,3a,75y,45.41h,90");//Colocamos la url de google maps
      ...
      //if(serialgps.available())
        //{
            ...
            //{
                ...
                lcd.clear(); // encera pantalla
                lcd.setCursor(0, 0);//ubicacion de cursos de LCD //Presentacion de mensaje
                lcd.print("VBat:");//ubicacion de cursos de LCD //Presentacion de mensaje
                lcd.setCursor(0, 1);//ubicacion de cursos de LCD //Presentacion de mensaje
                lcd.print("Vel:");//ubicacion de cursos de LCD //Presentacion de mensaje
          
                lcd.setCursor(6, 0);//ubicacion de cursos de LCD //Presentacion de mensaje
                lcd.print("13,7[v]");//ubicacion de cursos de LCD //Presentacion de mensaje
                lcd.setCursor(6, 1);//ubicacion de cursos de LCD //Presentacion de mensaje
                lcd.print("0,0 [km/h]");//ubicacion de cursos de LCD //Presentacion de mensaje

                delay(2500);
                lcd.clear(); // encera pantalla
                lcd.setCursor(0, 0);//ubicacion de cursos de LCD //Presentacion de mensaje
                lcd.print("Temp:");//ubicacion de cursos de LCD //Presentacion de mensaje
                
          
                lcd.setCursor(6, 0);//ubicacion de cursos de LCD //Presentacion de mensaje
                lcd.print("89,7[c]");//ubicacion de cursos de LCD //Presentacion de mensaje
