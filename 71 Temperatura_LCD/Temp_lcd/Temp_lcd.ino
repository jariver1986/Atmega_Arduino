...
void loop() {
  ...
  lcd.setCursor(10,1);
  lcd.print(Centigrados2);
  //lcd.setCursor(10,0);
  //lcd.print(Kelvin);
  Serial.println("@"+String(Centigrados)+"@="+String(Centigrados2)+"="+"@"+String(Centigrados)+"@="+String(Centigrados2)+"="+"@"+String(Centigrados)+"@="+String(Centigrados2)+"="+"@"+String(Centigrados)+"@="+String(Centigrados2)+"="+"@"+String(Centigrados)+"@="+String(Centigrados2)+"=");  
