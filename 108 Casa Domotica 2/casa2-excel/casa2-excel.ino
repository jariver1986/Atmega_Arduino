...
void setup() 
{
  ...
  Serial.println("LABEL,Hora,Ax,Ay,Az,Campo Magnetico,Iluminacion,Temperatura");
...
void loop() {
 ...
 //Sensor campo magnetico
  ...
  //Sensor Luz
  dato=analogRead(A0);
  iluminacion = ((500-dato)*100)/500;
  //Serial.println(dato);
  Serial.print("Iluminacion: " + String(iluminacion)+"%");
  Serial.print("\t");
  ...
  Serial.println((String)"DATA,"+hour()+":"+minute()+":"+second()+","+String(ax)+","+String(ay)+","+String(az)+","+String(estado)+","+String(iluminacion)+","+String(temperature) );
