...
void setup() 
{
  ...
  alerta();  
    ...
    lcd.setCursor(0,3); lcd.print("[F4]Criolifting");//Columna,Fila  
    delay(200);
...
void loop() 
{
  ...
  while(indio==3)
  {
    ...
    {
        lcd.clear();
        lcd.setCursor(0,0);lcd.print("Facial");      
    ...
    //###########################################TECLADO
      char key = keypad.getKey();
      if(key) {switch (key){case '#': indio=3; lcd.clear();}alerta();contador1=0;dosis=0;indio=0;centinela=-1;digitalWrite(valvula1, HIGH);}//Cuando key "B" es oprimida...
    //###########################################
    }
    ///////////////////////////////////////////////////////////////////////////////////////////////////////F1F2
    ...
    {
        lcd.clear();
        lcd.setCursor(0,0);lcd.print("Corporal");      
        lcd.setCursor(0,1);lcd.print("En pausa    ");
        lcd.setCursor(0,2); lcd.print("Dosis parcial: ");      
        lcd.setCursor(0,3); lcd.print("[Stop]Regresar");//Columna,Fila  
        indio=322;
    ...
    //###########################################TECLADO
      char key = keypad.getKey();
      if(key) {switch (key){case '#': indio=3; lcd.clear();}alerta();contador1=0;dosis=0;indio=0;centinela=-1;digitalWrite(valvula2, HIGH);digitalWrite(valvula1, HIGH);}//Cuando key "B" es oprimida...
    //###########################################
    }  
  ...
  while(indio==4)
  {
    ...
    {
      lcd.clear();
        lcd.setCursor(0,0);lcd.print("Rejuvenecimiento");      
        lcd.setCursor(0,1);lcd.print("En pausa    ");
        lcd.setCursor(0,2); lcd.print("Dosis parcial: ");      
        lcd.setCursor(0,3); lcd.print("[Stop]Regresar");//Columna,Fila  
        indio=411;
    ...
    //###########################################TECLADO
      char key = keypad.getKey();
      if(key) {switch (key){case '#': indio=4; lcd.clear();}alerta();contador1=0;dosis=0;indio=0;turno=0;digitalWrite(valvula2, HIGH);digitalWrite(valvula1, HIGH);}//Cuando key "B" es oprimida...
    //###########################################
    }
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////F2-2-Capilar
    ...
    {
      lcd.clear();
        lcd.setCursor(0,0);lcd.print("Capilar");      
        lcd.setCursor(0,1);lcd.print("En pausa    ");
        lcd.setCursor(0,2); lcd.print("Dosis parcial: ");      
        lcd.setCursor(0,3); lcd.print("[Stop]Regresar");//Columna,Fila  
        indio=422;
    ...
    {
        lcd.clear();
        lcd.setCursor(0,0);lcd.print("Cicatrices");      
        lcd.setCursor(0,1);lcd.print("En pausa    ");
        lcd.setCursor(0,2); lcd.print("Dosis parcial: ");      
        lcd.setCursor(0,3); lcd.print("[Stop]Regresar");//Columna,Fila  
        indio=433;
    ...
    {
      lcd.clear();
        lcd.setCursor(0,0);lcd.print("Papada");      
        lcd.setCursor(0,1);lcd.print("En pausa    ");
        lcd.setCursor(0,2); lcd.print("Dosis parcial: ");      
        lcd.setCursor(0,3); lcd.print("[Stop]Regresar");//Columna,Fila  
        indio=444;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////F2-5 Acne
    ...
    {
        lcd.clear();
        lcd.setCursor(0,0);lcd.print("Acne");      
        lcd.setCursor(0,1);lcd.print("En pausa    ");
        lcd.setCursor(0,2); lcd.print("Dosis parcial: ");      
        lcd.setCursor(0,3); lcd.print("[Stop]Regresar");//Columna,Fila  
        indio=455;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////F2-6 Post Operatoria
    ...
    {
        lcd.clear();
        lcd.setCursor(0,0);lcd.print("Post Operatorio");      
        lcd.setCursor(0,1);lcd.print("En pausa    ");
        lcd.setCursor(0,2); lcd.print("Dosis parcial: ");      
        lcd.setCursor(0,3); lcd.print("[Stop]Regresar");//Columna,Fila  
        indio=466;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////F2-7 Rosacea
    ...
    {
        lcd.clear();
        lcd.setCursor(0,0);lcd.print("Rosacea");      
        lcd.setCursor(0,1);lcd.print("En pausa    ");
        lcd.setCursor(0,2); lcd.print("Dosis parcial: ");      
        lcd.setCursor(0,3); lcd.print("[Stop]Regresar");//Columna,Fila  
        indio=477;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////F3-1-Reduccion
    ...
    {
      lcd.clear();
        lcd.setCursor(0,0);lcd.print("Reduccion");      
        lcd.setCursor(0,1);lcd.print("En pausa    ");
        lcd.setCursor(0,2); lcd.print("Dosis parcial: ");      
        lcd.setCursor(0,3); lcd.print("[Stop]Regresar");//Columna,Fila  
        indio=511;
    ...
    {
      lcd.clear();
        lcd.setCursor(0,0);lcd.print("Celulitis");      
        lcd.setCursor(0,1);lcd.print("En pausa    ");
        lcd.setCursor(0,2); lcd.print("Dosis parcial: ");      
        lcd.setCursor(0,3); lcd.print("[Stop]Regresar");//Columna,Fila  
        indio=522;
    ...
    {
      lcd.clear();
        lcd.setCursor(0,0);lcd.print("Estrias");      
        lcd.setCursor(0,1);lcd.print("En pausa    ");
        lcd.setCursor(0,2); lcd.print("Dosis parcial: ");      
        lcd.setCursor(0,3); lcd.print("[Stop]Regresar");//Columna,Fila  
        indio=544;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////F3-6 Acne Corporal
    ...
    {
        lcd.clear();
        lcd.setCursor(0,0);lcd.print("Acne Corporal");      
        lcd.setCursor(0,1);lcd.print("En pausa    ");
        lcd.setCursor(0,2); lcd.print("Dosis parcial: ");      
        lcd.setCursor(0,3); lcd.print("[Stop]Regresar");//Columna,Fila  
        indio=566;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////F3-7 Lesiones MIcrovasculares
    ...
    {
        lcd.clear();
        lcd.setCursor(0,0);lcd.print("L. Microvas.        ");      
        lcd.setCursor(0,1);lcd.print("En pausa    ");
        lcd.setCursor(0,2); lcd.print("Dosis parcial: ");      
        lcd.setCursor(0,3); lcd.print("[Stop]Regresar");//Columna,Fila  
        indio=577;
...
while(indio==66)
  {
    ...
    //###########################################TECLADO
      char key = keypad.getKey();
      if(key) {switch (key){case '#': indio=3; lcd.clear();}alerta();contador1=0;dosis=0;indio=0;turno=0;digitalWrite(valvula2, HIGH);digitalWrite(valvula1, HIGH);}//Cuando key "B" es oprimida...
    //###########################################
