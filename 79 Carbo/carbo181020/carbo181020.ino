...
void setup() 
{
  ...
  lcd.setCursor(0,3); lcd.print("[F4]Coolifting");//Columna,Fila  
  delay(1000);
}
...
void loop() 
{
  ...
  while(indio==3)
  {
    ...
    //###########################################TECLADO
      char key = keypad.getKey();
      if(key) {switch (key){case '#': indio=3; lcd.clear();alerta();contador1=0;dosis=0;indio=0;centinela=-1;digitalWrite(valvula1, HIGH);}      }
...
/////////////////////////////////////// //////////////////////////////////////////////////////////////////////////////////////////////////////F4Criolifting
    ...
    {
        lcd.clear();
        lcd.setCursor(0,0);lcd.print("Cool-Lifting   100cc");      
        lcd.setCursor(0,1);lcd.print("En pausa    ");   
        lcd.setCursor(0,3); lcd.print("[Stop]Regresar");//Columna,Fila  
        indio=66;
    }  
